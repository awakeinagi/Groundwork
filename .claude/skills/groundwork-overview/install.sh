#!/usr/bin/env bash
# Install the groundwork-overview skill from this repo (the canonical home, DEC-0318)
...
mkdir -p "$DEST"
rsync -a --delete --exclude __pycache__ "$HERE/" "$DEST/groundwork-overview/"
echo "installed groundwork-overview -> $DEST/groundwork-overview"
