...
([DEC-0041](DEC-0041-impact-ranked-reaffirmation-queue.md)) and the
Arbiter conflict queue
([DEC-0039](DEC-0039-conflict-escalation-operations.md)) needed a state
model.
...
[DEC-0131](DEC-0131-rebuild-sufficiency-invariant.md)'s discipline, and
...
([DEC-0144](DEC-0144-two-grade-governance-event-log.md)), not queue
