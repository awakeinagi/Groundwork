...
survives provider swaps ([DEC-0024](DEC-0024-pluggable-auth.md)) and
renames.

## Decision

`governance/people.yaml` — PR-gated like all governance
([DEC-0037](DEC-0037-governance-as-code.md)) — maps a stable person-id to
...
([DEC-0043](DEC-0043-oauth-reviews-program-user-fallback.md)) key off
