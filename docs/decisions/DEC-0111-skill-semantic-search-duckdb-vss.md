...
[DEC-0102](DEC-0102-v1-embedded-stack.md) had already committed
...
[DEC-0102](DEC-0102-v1-embedded-stack.md)'s vector-search commitment
...
- **Runtime `INSTALL vss` from DuckDB's extension repo**: needs network
  ...
  the pip route
  ([SES-0019](../sessions/SES-0019-semantic-search-hybrid-tooling.md) T2).
- **A non-DuckDB vector store (e.g., sqlite-vec, FAISS, chromadb)**:
  loses the dogfood alignment with
  [DEC-0102](DEC-0102-v1-embedded-stack.md) for no capability gain at
  this scale.

## Implications

The skill ships `scripts/groundwork_search.py`
([DEC-0116](DEC-0116-separate-search-script-and-index.md)) with hybrid
graph integration ([DEC-0119](DEC-0119-hybrid-retrieval-semantics.md));
