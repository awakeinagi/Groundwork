...
[ST-0019](../stories/ST-0019-code-host-connector-protocol.md) AC5
requires host webhooks to surface through the protocol as a normalized
event schema; [DEC-0145](../decisions/DEC-0145-event-driven-check-recomputation.md)
...
[DEC-0050](../decisions/DEC-0050-bitbucket-datacenter-v1.md) notes BBDC
...
Matches [DEC-0145](../decisions/DEC-0145-event-driven-check-recomputation.md)'s
...
([DEC-0050](../decisions/DEC-0050-bitbucket-datacenter-v1.md)). A
...
gate engine's sweep (per [DEC-0168](../decisions/DEC-0168-connector-minimum-capability-set.md)).
