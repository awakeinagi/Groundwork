...
The governance event log ([DEC-0042](DEC-0042-governance-reporting-split.md))
cannot fully meet the rebuild-sufficiency bar
([DEC-0131](DEC-0131-rebuild-sufficiency-invariant.md)): gate
...
Extends [DEC-0131](DEC-0131-rebuild-sufficiency-invariant.md)'s spirit
...
[DEC-0042](DEC-0042-governance-reporting-split.md) exists for keeps its
data.
...
- **Log as its own source of truth**: the second truth
  [DEC-0002](DEC-0002-doc-store-canonical.md) exists to prevent; a lost
