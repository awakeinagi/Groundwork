...
1. Renders the current shared draft with inline commenting, scoped to
   sections (per [DEC-0055](../decisions/DEC-0055-incremental-synthesis-shared-draft.md)).
2. A "propose change" action on a comment creates a `CP-` artifact (per
   [DEC-0047](../decisions/DEC-0047-change-proposal-artifact.md)) citing
...
Reuses [ST-0045](ST-0045-goal-artifact-view.md)'s section-scoped
