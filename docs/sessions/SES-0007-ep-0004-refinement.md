...
# SES-0007: [EP-0004](../epics/EP-0004-graph-index.md) Refinement Session
...
from the fork-pull model ([SES-0003](SES-0003-ep-0001-refinement.md)), pin the consistency and query
contracts its now-refined consumers need, and dispose of the twice-deferred
engine choice.

## Transcript

**T1 — Sponsor.** Approved [EP-0002](../epics/EP-0002-refinement-session-agent.md). Proceed with the next epic.

**T2 — Agent.** Chose [EP-0004](../epics/EP-0004-graph-index.md) (all three impactors settled). Round 1:
...
ops burden per [DEC-0050](../decisions/DEC-0050-bitbucket-datacenter-v1.md)); (d) query API shape (recommended named traversals
