...
DEC-0080 and
bound by CMP-0001's and
CMP-0004's forward-declared
consumption lists
(DEC-0132,
DEC-0142).
...
- `HostEvent.B-2` — delivery: at-least-once, ordered only within a
  ...
  CMP-0002's delivery contract shape
  (per DEC-0145).
